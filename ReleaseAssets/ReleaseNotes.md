...
* In Measurement Mode, you can now speed up initial setup of upper/lower bound estimates by using your mouse instead (default hotkey is `[Alt][/]` to toggle recording). 
