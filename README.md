...
With this script, sub-increment accuracy is preserved between rotations. This means that you can use the script to measure any base yaw to high precision by observing drifts over many cycles. In other words, the more turns you used to match, the more accurate your measurement gets (accurate to 16 significant digits).
