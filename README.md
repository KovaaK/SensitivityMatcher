...
If the game you are coming from is not listed, to measure an unknown increment, select "Measure any game" and enter your best guess for the unknown values, then:
