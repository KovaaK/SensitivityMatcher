...
4) You can now match the captured sensitivity to any game, simply select the game from presets to display the right value, or use the repeater to adjust the value in-game if the preset is not listed.
