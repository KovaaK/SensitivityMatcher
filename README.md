...
This script can match your mouse sensitivity between any 3D games directly, with no paywall calculator involved. [Download.](https://github.com/KovaaK/SensitivityMatcher/releases/latest)
