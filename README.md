...
4) You can now match your captured sensitivity to any game you like, either by using the repeater to adjust the in-game setting, or if the game is already listed in the dropdown, simply select it to output the number you should enter in-game.
