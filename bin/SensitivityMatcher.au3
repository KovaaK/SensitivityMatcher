...
Func HandyCalculator($idGUICalc, ByRef $sInput, $idMsg)
   ...
   Else
      If $idGUICalc == "INITIALIZE" Then
         ...
         $sInput[0]=GUICtrlCreateInput($gSens             , 80, 10, 80, 20)
                    GUICtrlSendMsg(    $sInput[0], $EM_SETREADONLY,  1,  0)
         $sInput[1]=GUICtrlCreateInput(800                , 80, 30, 80, 20)
         $sInput[2]=GUICtrlCreateInput(800*$gSens/25.4    , 15, 85, 75, 20)
         $sInput[3]=GUICtrlCreateInput(800*$gSens*60      ,110, 85, 75, 20)
         $sInput[4]=GUICtrlCreateInput(360/$gSens/800*2.54, 15,150, 75, 20)
         $sInput[5]=GUICtrlCreateInput(360/$gSens/800     ,110,150, 75, 20)
         GUICtrlCreateLabel("Virtual Scale",10,13,65,15,$SS_RIGHT)
         GUICtrlCreateLabel("Physical Scale",10,33,65,15,$SS_RIGHT)
         GUICtrlCreateLabel("deg",165,13,35,15,$SS_LEFT)
         GUICtrlCreateLabel("CPI",165,33,35,15,$SS_LEFT)
         GUICtrlCreateLabel("Curvature",10,65,180,15,$SS_CENTER)
         GUICtrlCreateLabel("deg/mm",15,105,75,15,$SS_CENTER)
         GUICtrlCreateLabel("MPI",110,105,75,15,$SS_CENTER)
         GUICtrlCreateLabel("Circumference",10,130,180,15,$SS_CENTER)
         GUICtrlCreateLabel("cm/rev",15,170,75,15,$SS_CENTER)
         GUICtrlCreateLabel("in/rev",110,170,75,15,$SS_CENTER)
         GUISetState(@SW_SHOW)
